...
var PasswordStrengthMeter = ({
  ...
  const [level, setLevel] = react.useState("weak");
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `password-strength-meter ${className}`, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "password-strength-meter__progress", children: /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        role: "progressbar",
